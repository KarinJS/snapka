...
import {
  relativeExecutablePath as chromeHeadlessShellRelativeExecutablePath,
  compareVersions as chromeHeadlessShellCompareVersions,
} from './chrome-headless-shell.js'
import {
  resolveSystemExecutablePaths as chromeResolveSystemExecutablePaths,
  relativeExecutablePath as chromeRelativeExecutablePath,
  compareVersions as chromeCompareVersions,
} from './chrome.js'
import {
  relativeExecutablePath as chromedriverRelativeExecutablePath,
  compareVersions as chromedriverCompareVersions,
} from './chromedriver.js'
import {
  relativeExecutablePath as chromiumRelativeExecutablePath,
  compareVersions as chromiumCompareVersions,
} from './chromium.js'
import {
  relativeExecutablePath as firefoxRelativeExecutablePath,
  compareVersions as firefoxCompareVersions,
} from './firefox.js'
import {
  Browser,
  BrowserPlatform,
...
export const executablePathByBrowser = {
  [Browser.CHROMEDRIVER]: chromedriverRelativeExecutablePath,
  [Browser.CHROMEHEADLESSSHELL]: chromeHeadlessShellRelativeExecutablePath,
  [Browser.CHROME]: chromeRelativeExecutablePath,
  [Browser.CHROMIUM]: chromiumRelativeExecutablePath,
  [Browser.FIREFOX]: firefoxRelativeExecutablePath,
}

export const versionComparators = {
  [Browser.CHROMEDRIVER]: chromedriverCompareVersions,
  [Browser.CHROMEHEADLESSSHELL]: chromeHeadlessShellCompareVersions,
  [Browser.CHROME]: chromeCompareVersions,
  [Browser.CHROMIUM]: chromiumCompareVersions,
  [Browser.FIREFOX]: firefoxCompareVersions,
}
...
export function resolveSystemExecutablePaths (
  ...
  switch (browser) {
    ...
    case Browser.CHROME:
      return chromeResolveSystemExecutablePaths(platform, channel)
  }
}
